...
url = "https://www.cits.wa.gov.au/funding"
...
# Keep only objects where closed == False
filtered_grants = [obj for obj in grantListArr if obj.get("isClosed") == False]
...
collection = db["wa_creative"]  # You can change the collection name if you want
